...
<body>
    <header class="header">
        ...
        <li><a href="{{URL::route('account-change-password')}}">Cha nge Password</a></li>
                        @else
        ...
        <div class="banner-container">
            ...
            <div class="container banner-content">
                <div id="da-slider" class="da-slider">
                    <div class="da-slide">
                        <h2>Webdeveloper</h2>
                        <p>I am a developer, Coder and a daydreamer!!!</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
                        <h2>Php Developer</h2>
                        <p>I develop websites using Laravel PHP framework..</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
                        <h2>Magento/Prestashop/Opencart</h2>
                        <p>I develop ecommerce websites using Magento,Prestashop and Opencart framework.</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
    ...
    <section id="aboutUs" class="secPad">
        <div class="container">
            <div class="heading text-center">
                <!-- Heading -->
                <h2>I am Jay, a Web Developer</h2>
    ...
    <section id="contactUs" class="page-section secPad">
        <div class="container">
            ...
            <div class="row mrgn30">
                ...
                <form method="post" action="{{URL::route('contact-me')}}" id="contactfrm" role="form">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <textarea name="message" class="form-control" id="message" cols="3" rows="5" placeholder="Enter your message…" title="Please enter your message (at least 10 characters)" required></textarea>
                        </div>
                        <input name="submit" type="submit" class="btn btn-lg btn-primary" Value="Submit" id="submit" />            
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    Copyright 2015 | Jay Desai - Php and Ecommerce Web developer.
                </div>
            </div>
            <!-- / .row -->
        </div>
